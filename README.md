<div align="center">
  ...
  <h3><b>Set up a "Hello world" project with two apps</b></h3>
...
- [📖 Set up a "Hello world" project with two apps ](#-set-up-a-hello-world-project-with-two-apps-)
...
<details>
  ...
  <ul>
    <li><a href="https://guides.rubyonrails.org/7_0_release_notes.html">Ruby Rails.</a></li>
  </ul>
</details>
...
```sh
  git clone https://github.com/learnwithalfred/congenial-adventure
```
